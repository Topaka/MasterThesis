...
internal language analysis and the big and bulky industry programming evaluation methods\cite{BlueJBlackbox}. This new method used the discount usability evaluation and the IDA methods as a basis, with the main difference being to avoid the use of a compiler or an IDE. To test this method, we used Quorum, an evidence-based programming language\cite{Quorum}. This entailed conducting a qualitative experiment with six experienced programmers as participants.
...
In the context of HCI techniques, we have examined the usefulness of the discount usability method with the IDA method for data analysis on C\# along with examining literature for similar experiments.
