...
\begin{table}[]
\caption{My caption\todo{either remove caption and force to be at the right position to emulate task formatting, or ref and write caption to fit latex formatting}}
\label{my-label}
\begin{tabular}{llll}
