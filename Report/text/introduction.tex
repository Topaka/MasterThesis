...
In the field of Human-Computer Interaction (HCI) there has been a similar problem with usability evaluation methods.
Traditional usability studies often required many subjects and studying the use of the program over a long period of time\todo{I have no source for this}.
This made them prohibitively costly for companies both in resources spent and time-to-market, which prompted the development of a discount usability evaluation method\cite{AndrewMonk}.%might be slightly off with the reference
...
We want to have a method for evaluating programming languages, which is lightweight enough to be used by language designers in the early stages of design, both to improve the language, and support claims about the language.
